...
Mark files that should not be manually modified.

### Pattern

```markdown
<!-- WARNING: IMMUTABLE - This file is {reason}. {consequence}. -->
```
...
<!-- WARNING: IMMUTABLE - Session archive. Do not modify after completion. -->

<!-- WARNING: READ-ONLY REFERENCE - Source of truth is session file. -->
```
